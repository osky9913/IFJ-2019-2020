...
string_t* define_unique_variable(string_t *frame, int *uniq, char *name){
    ...
    if (name) {
        create_unique_variable(variable, uniq, name);
    }
    else {
        create_unique_variable(variable, uniq, "var");
    }
...
char *generate_expression(token_t *operand2, token_t *operator, token_t *operand1){
    ...
    // -----------------------------------------------------------definice DEFVAR--------------------------------------------------------------
    string_t  * temporary_div1 = define_unique_variable(switching_output_definitions, &identificator.general, "temporary_div");
    string_t  * temporary_div2 = define_unique_variable(switching_output_definitions, &identificator.general, "temporary_div");

    string_t  * flag_1 = define_unique_variable(switching_output_definitions, &identificator.general, "flag_1_variable");
    string_t  * flag_2 = define_unique_variable(switching_output_definitions, &identificator.general, "flag_2_variable");


    string_t *result = define_unique_variable(switching_output_definitions, &identificator.general, "result");
    //string which will store result of current operation (DEFVAR result)
    //string which will store first operand (DEFVAR operand1)
    string_t *variable1 = define_unique_variable(switching_output_definitions, &identificator.general, "var");
    //string which will store second operand (DEFVAR operand1)
    string_t *variable2 = define_unique_variable(switching_output_definitions, &identificator.general, "var");
    //string used as temporary storing place in operator >= or <=
    string_t *result_eq_1 = define_unique_variable(switching_output_definitions, &identificator.general,"tmp_result");
    //string used as temporary storing place in operator >= or <=
    string_t *result_eq_2 = define_unique_variable(switching_output_definitions, &identificator.general, "tmp_result");
    //string used as label for the end of expression evaluation

    string_t * assembly_1_variable = define_unique_variable(switching_output_definitions, &identificator.general, "assembly_1_variable");
    string_t * assembly_2_variable = define_unique_variable(switching_output_definitions, &identificator.general, "assembly_2_variable");
    ...
    create_unique_label(label_LSOREQ,&identificator.label,"%label_LSOREQ");
    create_unique_label(label_GTOREQ,&identificator.label,"%label_GTOREQ");
    create_unique_label(label_ISEQ,&identificator.label,"%label_ISEQ");
    create_unique_label(label_LS,&identificator.label,"%label_LS");
    create_unique_label(label_GT,&identificator.label,"%label_GT");
    create_unique_label(label_ADD,&identificator.label,"%label_ADD");
    create_unique_label(label_SUB,&identificator.label,"%label_SUB");
    create_unique_label(label_MUL,&identificator.label,"%label_MUL");
    create_unique_label(label_DIV,&identificator.label,"%label_DIV");
    create_unique_label(label_IDIV,&identificator.label,"%label_IDIV");
    create_unique_label(label_ISNEQ,&identificator.label,"%label_ISNEQ");


    create_unique_label(int_to_float,&identificator.label,"%label_int_to_float");
    create_unique_label(float_to_int,&identificator.label,"%label_float_to_int");
    create_unique_label(_2_ints_to_floats,&identificator.label,"%_2_int_to_float");


    create_unique_label(label_bool_int_float_1, &identificator.label, "%bool_int_to_float_1");
    create_unique_label(label_bool_int_float_2, &identificator.label, "%bool_int_to_float_2");
    create_unique_label(is_eq_1_int, &identificator.label, "%is_eq_1_int");
    create_unique_label(is_eq_2_int, &identificator.label, "%is_eq_2_int");


    //-------------------------------------------------------------Labels for operation -----------------------------------------------
    //------------------------------------------------------------ Labels for expression -----------------------------------------------------
    string_t *end_of_expression = string_create_init();
    create_unique_label(end_of_expression, &identificator.label, "%end_expression_label");
    string_t *concatenation_label = string_create_init();
    create_unique_label(concatenation_label, &identificator.concat_label, "%concatenation");
    string_t *label_int_dodge = string_create_init();
    create_unique_label(label_int_dodge, &identificator.label, "%label_float_dodge");
...
void generate_print(const char* label){
    ...
    for(int i = identificator.param_def; i < identificator.param_call; i++){
        ...
        create_unique_variable(check_variable, &identificator.general, "%check_type");
        ...
        create_unique_variable(parameter, &identificator.param_def, "%param");
        ...
        create_unique_variable(none_label, &identificator.label, "%none_label");
        ...
        create_unique_variable(process_next_param, &identificator.label, "%next_param");
...
void generate_call_function(const char *id){
    ...
    if((strcmp(id, "print")) == 0){
        ...
        create_unique_variable(print_label, &identificator.general, "%print");
...
void generate_call_param(token_t *id){
    ...
    string_t *parameter = string_create_init();
    create_unique_variable(parameter, &identificator.param_call, "%param");
...
// ?
    ...
    string_t *while_expression = define_unique_variable(switching_output_definitions, &identificator.expression, "%while_expression");
    ...
    //unique label for int comparison
    create_unique_label(while_int_label, (int *)(stack_general_top(general_stacks.while_labels_stack)->data), "%while_int_label");
    //unique label for float comparison
    create_unique_label(while_float_label, (int *)(stack_general_top(general_stacks.while_labels_stack)->data), "%while_float_label");
    //unique label for bool comparison
    create_unique_label(while_bool_label, (int *)(stack_general_top(general_stacks.while_labels_stack)->data), "%while_bool_label");
    //unique label for jumping to the body of while cycle
    create_unique_label(while_body_label, (int *)(stack_general_top(general_stacks.while_labels_stack)->data), "%while_body_label");
    //unique label for jumping at the end of the cycle
    create_unique_label(while_end_label, (int *)(stack_general_top(general_stacks.while_labels_stack)->data), "%while_end_label");

    //variable which will store type of passed expression
    string_t *id_type = define_unique_variable(switching_output_definitions, &identificator.expression, "%while_check_type");
...
void generate_while_label(){
    ...
    *tmp_label_count = ++identificator.while_label;
    ...
    create_unique_label(while_beginning_label, 
...
void generate_while_end(){
    ...
    create_unique_label(while_end_label, (int *)(stack_general_top(general_stacks.while_labels_stack)->data), "%while_end_label");
    create_unique_label(while_beginning_label, (int *)(stack_general_top(general_stacks.while_labels_stack)->data), "%while_beginning_label");
    ...
    //increase the label unique variable, so that in next while are going to be different labels
...
void generate_if(token_t *expression){
    ...
    *tmp_label_count = ++identificator.if_label;
    ...
    string_t *if_expression = define_unique_variable( switching_output_definitions, &identificator.expression, "%if_expression");
    ...
    //unique label used to jump to else body
    string_t *else_body_label = string_create_init();
    //unique label used to jump to if body
    string_t *if_body_label = string_create_init();

    string_append(switching_output, "\n#if else statement\n");
    //unique label for int comparison
    create_unique_label(if_int_label, (int *)(stack_general_top(general_stacks.if_labels_stack)->data), "%if_int_label");
    //unique label for float comparison
    create_unique_label(if_float_label, (int *)(stack_general_top(general_stacks.if_labels_stack)->data), "%if_float_label");
    //unique label for bool comparison
    create_unique_label(if_bool_label, (int *)(stack_general_top(general_stacks.if_labels_stack)->data), "%if_bool_label");
    //unique label for jumping to the body of while cycle
    create_unique_label(else_body_label, (int *)(stack_general_top(general_stacks.if_labels_stack)->data), "%else_body_label");
    //unique label for jumping at the end of the cycle
    create_unique_label(if_body_label, (int *)(stack_general_top(general_stacks.if_labels_stack)->data), "%if_body_label");
    ...
    string_t *id_type = define_unique_variable(switching_output_definitions, &identificator.expression, "%if_check_type");
...
void generate_else(){
    ...
    string_t *else_body_label = string_create_init();
    //unique label for else if
    string_t *else_if_end_label = string_create_init();
    create_unique_label(else_if_end_label, (int *)(stack_general_top(general_stacks.if_labels_stack)->data), "%else_if_end_label");
    //unique label for jumping to the body of else
    create_unique_label(else_body_label, (int *)(stack_general_top(general_stacks.if_labels_stack)->data), "%else_body_label");
    ...
    //unique for if labels will be set to one
    string_free(else_body_label);
